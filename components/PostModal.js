...
export default function PostModal() {
    const styles = {
        wrapper: 'w-[70rem] h-[40rem] flex flex-col justify-start items-center gap-[1rem] p-[1rem] overflow-scroll overflow-x-hidden',
        title: 'font-bold my-[2rem]',
    ...
    return (
        <div className={styles.wrapper}>
            ...
            <div className={styles.smallField}>
                <span className={styles.fieldTitle}>Estimated Read Length<br></br>(in minutes)</span>
                <span className={styles.inputContainer}>
                    <input
                        className={styles.inputField}
                        type='text'
